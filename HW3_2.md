...
```
    ...
    ## `summarise()` has grouped output by 'seqn', 'sex', 'education', 'age'. You can
...
![](HW3_2_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

Data appears off and unable to troubleshoot. However we would expect the
most amount of activity during day time hours (maybe after 7am), and
activity decreasing in the evening (after 9pm).
...
![](HW3_2_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->

There were overall longer duration rides in 2020 compared to 2024.
Across both years, the summer month July has higher mediation duration
rides than the winter month January. There is wider variation in 2020
between January and July compared to 2024.
...
![](HW3_2_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->

Casual members appear to have higher median ride durations than members
do across both monthy and rideable_type. January tends to have short
ride durations than July does, which makes sense since it is easier and
more enjoyable to bike in the summer. ride in the summer
