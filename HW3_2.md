...
```
    ...
    ## # A tibble: 6 × 7
    ##   seqn  obs     min sex     age   bmi education
    ##   <fct> <chr> <dbl> <fct> <dbl> <dbl> <fct>    
    ## 1 62161 min1  1.11  1        22  23.3 2        
    ## 2 62161 min2  3.12  1        22  23.3 2        
    ## 3 62161 min3  1.47  1        22  23.3 2        
    ## 4 62161 min4  0.938 1        22  23.3 2        
    ## 5 62161 min5  1.60  1        22  23.3 2        
    ## 6 62161 min6  0.145 1        22  23.3 2
